...
namespace IO.Swagger.Api
{
    ...
    public interface IPropostaApi : IApiAccessor
    {
        ...
        /// <returns>List&lt;DocumentoProposta&gt;</returns>
        ...
        /// <param name="codigoLojista">Código do lojista (Rede de loja). (fixo informada pela financeira).</param>
        /// <param name="tipoDocumento">Tipo do documento.</param>
        /// <returns>ApiResponse of List&lt;DocumentoProposta&gt;</returns>
        ApiResponse<List<DocumentoProposta>> PropostasIdDocumentosGetWithHttpInfo (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista, string tipoDocumento);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="codigoLoja">Código da loja (Filial). (fixo informada pela financeira).</param>
        /// <param name="codigoLojista">Código do lojista (Rede de loja). (fixo informada pela financeira).</param>
        /// <returns>ApiResponse of List&lt;Oferta&gt;</returns>
        ApiResponse<List<Oferta>> PropostasIdOfertasGetWithHttpInfo (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="codigoLoja">Código da loja (Filial). (fixo informada pela financeira).</param>
        /// <param name="codigoLojista">Código do lojista (Rede de loja). (fixo informada pela financeira).</param>
        /// <returns>List&lt;Pendencia&gt;</returns>
        ...
        /// <param name="codigoLoja">Código da loja (Filial). (fixo informada pela financeira).</param>
        /// <param name="codigoLojista">Código do lojista (Rede de loja). (fixo informada pela financeira).</param>
        /// <returns>ApiResponse of List&lt;Pendencia&gt;</returns>
        ApiResponse<List<Pendencia>> PropostasIdPendenciasGetWithHttpInfo (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="codigoLojista">Código do lojista (Rede de loja). (fixo informada pela financeira).</param>
        /// <param name="tipoDocumento">Tipo do documento.</param>
        /// <returns>Task of List&lt;DocumentoProposta&gt;</returns>
        System.Threading.Tasks.Task<List<DocumentoProposta>> PropostasIdDocumentosGetAsync (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista, string tipoDocumento);
        ...
        /// <param name="codigoLojista">Código do lojista (Rede de loja). (fixo informada pela financeira).</param>
        /// <param name="tipoDocumento">Tipo do documento.</param>
        /// <returns>Task of ApiResponse (List&lt;DocumentoProposta&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<DocumentoProposta>>> PropostasIdDocumentosGetAsyncWithHttpInfo (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista, string tipoDocumento);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="codigoLoja">Código da loja (Filial). (fixo informada pela financeira).</param>
        /// <param name="codigoLojista">Código do lojista (Rede de loja). (fixo informada pela financeira).</param>
        /// <returns>Task of List&lt;Oferta&gt;</returns>
        System.Threading.Tasks.Task<List<Oferta>> PropostasIdOfertasGetAsync (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista);
        ...
        /// <param name="codigoLoja">Código da loja (Filial). (fixo informada pela financeira).</param>
        /// <param name="codigoLojista">Código do lojista (Rede de loja). (fixo informada pela financeira).</param>
        /// <returns>Task of ApiResponse (List&lt;Oferta&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<Oferta>>> PropostasIdOfertasGetAsyncWithHttpInfo (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="codigoLoja">Código da loja (Filial). (fixo informada pela financeira).</param>
        /// <param name="codigoLojista">Código do lojista (Rede de loja). (fixo informada pela financeira).</param>
        /// <returns>Task of List&lt;Pendencia&gt;</returns>
        System.Threading.Tasks.Task<List<Pendencia>> PropostasIdPendenciasGetAsync (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista);
        ...
        /// <param name="codigoLoja">Código da loja (Filial). (fixo informada pela financeira).</param>
        /// <param name="codigoLojista">Código do lojista (Rede de loja). (fixo informada pela financeira).</param>
        /// <returns>Task of ApiResponse (List&lt;Pendencia&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<Pendencia>>> PropostasIdPendenciasGetAsyncWithHttpInfo (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class PropostaApi : IPropostaApi
    {
        ...
        /// <param name="tipoDocumento">Tipo do documento.</param>
        /// <returns>List&lt;DocumentoProposta&gt;</returns>
        public List<DocumentoProposta> PropostasIdDocumentosGet (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista, string tipoDocumento)
        {
             ApiResponse<List<DocumentoProposta>> localVarResponse = PropostasIdDocumentosGetWithHttpInfo(id, clientId, accessToken, xAuthorization, codigoLoja, codigoLojista, tipoDocumento);
             return localVarResponse.Data;
        }
        ...
        /// <param name="tipoDocumento">Tipo do documento.</param>
        /// <returns>ApiResponse of List&lt;DocumentoProposta&gt;</returns>
        public ApiResponse< List<DocumentoProposta> > PropostasIdDocumentosGetWithHttpInfo (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista, string tipoDocumento)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            ...
            return new ApiResponse<List<DocumentoProposta>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<DocumentoProposta>) Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<DocumentoProposta>)));
        }
        ...
        /// <param name="tipoDocumento">Tipo do documento.</param>
        /// <returns>Task of List&lt;DocumentoProposta&gt;</returns>
        public async System.Threading.Tasks.Task<List<DocumentoProposta>> PropostasIdDocumentosGetAsync (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista, string tipoDocumento)
        {
             ApiResponse<List<DocumentoProposta>> localVarResponse = await PropostasIdDocumentosGetAsyncWithHttpInfo(id, clientId, accessToken, xAuthorization, codigoLoja, codigoLojista, tipoDocumento);
             return localVarResponse.Data;
        ...
        /// <param name="tipoDocumento">Tipo do documento.</param>
        /// <returns>Task of ApiResponse (List&lt;DocumentoProposta&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<DocumentoProposta>>> PropostasIdDocumentosGetAsyncWithHttpInfo (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista, string tipoDocumento)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling PropostaApi->PropostasIdDocumentosGet");
        ...
        /// <param name="codigoLojista">Código do lojista (Rede de loja). (fixo informada pela financeira).</param>
        /// <returns>List&lt;Oferta&gt;</returns>
        public List<Oferta> PropostasIdOfertasGet (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista)
        {
             ApiResponse<List<Oferta>> localVarResponse = PropostasIdOfertasGetWithHttpInfo(id, clientId, accessToken, xAuthorization, codigoLoja, codigoLojista);
             return localVarResponse.Data;
        }
        ...
        /// <param name="codigoLojista">Código do lojista (Rede de loja). (fixo informada pela financeira).</param>
        /// <returns>ApiResponse of List&lt;Oferta&gt;</returns>
        public ApiResponse< List<Oferta> > PropostasIdOfertasGetWithHttpInfo (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            ...
            return new ApiResponse<List<Oferta>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<Oferta>) Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<Oferta>)));
        }
        ...
        /// <param name="codigoLojista">Código do lojista (Rede de loja). (fixo informada pela financeira).</param>
        /// <returns>Task of List&lt;Oferta&gt;</returns>
        public async System.Threading.Tasks.Task<List<Oferta>> PropostasIdOfertasGetAsync (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista)
        {
             ApiResponse<List<Oferta>> localVarResponse = await PropostasIdOfertasGetAsyncWithHttpInfo(id, clientId, accessToken, xAuthorization, codigoLoja, codigoLojista);
             return localVarResponse.Data;
        ...
        /// <param name="codigoLojista">Código do lojista (Rede de loja). (fixo informada pela financeira).</param>
        /// <returns>Task of ApiResponse (List&lt;Oferta&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<Oferta>>> PropostasIdOfertasGetAsyncWithHttpInfo (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling PropostaApi->PropostasIdOfertasGet");
        ...
        /// <param name="codigoLojista">Código do lojista (Rede de loja). (fixo informada pela financeira).</param>
        /// <returns>List&lt;Pendencia&gt;</returns>
        public List<Pendencia> PropostasIdPendenciasGet (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista)
        {
             ApiResponse<List<Pendencia>> localVarResponse = PropostasIdPendenciasGetWithHttpInfo(id, clientId, accessToken, xAuthorization, codigoLoja, codigoLojista);
             return localVarResponse.Data;
        }
        ...
        /// <param name="codigoLojista">Código do lojista (Rede de loja). (fixo informada pela financeira).</param>
        /// <returns>ApiResponse of List&lt;Pendencia&gt;</returns>
        public ApiResponse< List<Pendencia> > PropostasIdPendenciasGetWithHttpInfo (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            ...
            return new ApiResponse<List<Pendencia>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<Pendencia>) Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<Pendencia>)));
        }
        ...
        /// <param name="codigoLojista">Código do lojista (Rede de loja). (fixo informada pela financeira).</param>
        /// <returns>Task of List&lt;Pendencia&gt;</returns>
        public async System.Threading.Tasks.Task<List<Pendencia>> PropostasIdPendenciasGetAsync (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista)
        {
             ApiResponse<List<Pendencia>> localVarResponse = await PropostasIdPendenciasGetAsyncWithHttpInfo(id, clientId, accessToken, xAuthorization, codigoLoja, codigoLojista);
             return localVarResponse.Data;
        ...
        /// <param name="codigoLojista">Código do lojista (Rede de loja). (fixo informada pela financeira).</param>
        /// <returns>Task of ApiResponse (List&lt;Pendencia&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<Pendencia>>> PropostasIdPendenciasGetAsyncWithHttpInfo (string id, string clientId, string accessToken, byte[] xAuthorization, string codigoLoja, string codigoLojista)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling PropostaApi->PropostasIdPendenciasGet");
